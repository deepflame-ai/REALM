...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.__name__ = 'GraphUNet'

        pool='random'
        list_r=[0.05, 0.2, 0.5, 1]
        ...
        self.L = args.n_layers
        self.layer = layer
        self.pool_type = pool
        self.pool_ratio = pool_ratio
        self.list_r = list_r
        self.size_hidden_layers = args.width
        self.size_hidden_layers_init = args.width
        self.max_neighbors = max_neighbors
        self.dim_enc = args.width
        self.bn_bool = True
        self.res = False
        self.head = args.n_heads
        self.activation = nn.ReLU()

        self.encoder = MLP(args.in_dim, args.width * 2, args.width, n_layers=0, res=False,
                           act=args.act)
    ...
    def forward(self, data, roll_out=False):
        ...
        x, coords, edge_index = data.input_fields, data.pos, data.edge_index
